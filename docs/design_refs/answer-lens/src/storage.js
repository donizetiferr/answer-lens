...
export const STORAGE_KEY = 'answer-lens.preview.session.v2';
export const LEGACY_KEY = 'answer-lens.preview.session.v1';
export const LOCK_NAME = 'answer-lens-preview-device-v2';
